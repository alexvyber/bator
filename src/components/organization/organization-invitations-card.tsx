...
export function OrganizationInvitationsCard({
  ...
  return <OrganizationInvitationsContent className={className} classNames={classNames} localization={localization} organization={organization} {...props} />;
}
    ...
    >
      <CardContent className={cn("grid gap-4", classNames?.content)}>
        {pendingInvitations.map((invitation) => (
          <InvitationCell key={invitation.id} classNames={classNames} invitation={invitation} localization={localization} organization={organization} />
        ))}
      </CardContent>
    </SettingsCard>
  );
