...
export function MemberCell({ className, classNames, member, localization: localizationProp, hideActions }: MemberCellProps) {
  ...
  return (
    <>
        ...
        {!hideActions && (isSelf || member.role !== "owner" || myRole === "owner") && (
          <DropdownMenu>
            ...
            <DropdownMenuContent onCloseAutoFocus={(e) => e.preventDefault()}>
              ...
              <DropdownMenuItem onClick={() => (isSelf ? setLeaveDialogOpen(true) : setRemoveDialogOpen(true))} variant="destructive">
      ...
      <RemoveMemberDialog open={removeDialogOpen} onOpenChange={setRemoveDialogOpen} member={member} classNames={classNames} localization={localization} />
